...
public class BeneficiaryInternationaltransfer {
    ...
    public void FillBeneficiaryDetails(AndroidDriver driver) throws InterruptedException {
        Thread.sleep(1000);
        ...
        el2.click();
        el2.sendKeys("AE890570000011000494010");
    ...
    public void selectBeneficiary(AndroidDriver driver) throws InterruptedException {
        InternationaTransfers.bene_icon(driver);
        Thread.sleep(1000);

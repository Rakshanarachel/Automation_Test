...
public static void beneficiary_details_screen(AndroidDriver driver) throws IOException, InterruptedException {
    ...
    public static void production_benificiary(AndroidDriver driver) throws IOException {
        try {
            MobileElement name = (MobileElement) driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ScrollView/android.widget.RelativeLayout/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.EditText");
            BeneficiaryName = name.getText();
            MobileElement accc = (MobileElement) driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ScrollView/android.widget.RelativeLayout/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.EditText");
            BeneficiaryAccount = accc.getText();
            MobileElement BIC = (MobileElement) driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ScrollView/android.widget.RelativeLayout/android.widget.LinearLayout[3]/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.EditText");

            MobileElement ADD1 = (MobileElement) driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ScrollView/android.widget.RelativeLayout/android.widget.LinearLayout[4]/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.EditText");

            MobileElement ADD2 = (MobileElement) driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ScrollView/android.widget.RelativeLayout/android.widget.LinearLayout[4]/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.EditText");
            ...
            ex.BeneficiaryWrite(BeneficiaryName, BeneficiaryAccount, BIC.getText(), "-", "-", "-", "-", ADD1.getText(), ADD2.getText(), COUNTRY.getText());
            System.out.println("*********************BENEFICIARY SCREEN DETAILS ARE CAPTURED************************");
...
logger.info("Validation for Transfer amount");
...
int lenth=Equi_amount.getText().length();
    logger.info("Validation for Equivalent amount");
    ...
    logger.info("Validation for Beneficiary name");
    ...
    logger.info("Validation for Beneficiary Account Number");
   ...
   // System.out.println(BeneficiaryAccount+" "+ bene_acc_number.getText());
    ...
    logger.info("Validation for Total Debit amount");
    ...
    logger.info("Validation for Exchange Rate");
    ...
    if(charge.equals("IPAC")) {
        ...
        logger.info("Validation for remittance Fee");
        ...
        logger.info("Validation for correspondent Fee");
        ...
        logger.info("Validation for vat amount");
        ...
        scrollToText(driver,"Hide details");
        MobileElement remittance = (MobileElement) driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.ScrollView/android.view.ViewGroup/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.LinearLayout[2]/android.widget.TextView[2]");
        logger.info("Validation for remittance Fees");
        assertions.Assertions(ipremittance_fee, remittance.getText());
        MobileElement vat = (MobileElement) driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.ScrollView/android.view.ViewGroup/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.LinearLayout[3]/android.widget.TextView[2]");
        logger.info("Validation for VAT ");
        assertions.Assertions(ipvatamount, vat.getText());

    }
}
public static void Samecurrency_review_screen(AndroidDriver driver,String charge,String Currency) throws IOException, InterruptedException {
    ...
    logger.info("Validation for beneficiary account");
...
if(charge.equals("IPAC")) {
    ...
    logger.info("Validation for debit amount");
    ...
    logger.info("Validation for correspondent fees");
    ...
    public static void chargesDetails(AndroidDriver driver,String FROM_ACCOUNT,String currency) throws InterruptedException, IOException {
        ...
        if(FROM_ACCOUNT.equals(currency)){
            ...
            InternationaTransfers.scrollToText(driver, "Continue");
            Thread.sleep(1000);
            //MobileElement FEES = (MobileElement) driver.findElementByXPath("//android.widget.TextView[@text='Remittance fees']/following-sibling::android.widget.TextView[@index=1 and @resource-id='com.backbase.retail.neoUATMob:id/value']");
            //            assertions.Assertions(Rvfees,FEES.getText());
            ScreenShot.screenShot(driver,"D:\\j5\\InternationalTransfer'"+ ScreenShot.c+++"'.png");
            MobileElement remittance = (MobileElement) driver.findElementByXPath("//android.widget.TextView[@text='Remittance fees']/following-sibling::android.widget.TextView[@index=1 and @resource-id='com.backbase.retail.neoUATMob:id/value']");
            ipremittance_fee = remittance.getText();
            logger.info("Remittance fees : " + remittance.getText());
            MobileElement correspondentcharge = (MobileElement) driver.findElementByXPath("//android.widget.TextView[@text='Correspondent bank fees']/following-sibling::android.widget.TextView[@index=1 and @resource-id='com.backbase.retail.neoUATMob:id/value']");
            ipcorr_fee = correspondentcharge.getText();
            logger.info("correspondent charges : " + correspondentcharge.getText());
            MobileElement vat = (MobileElement) driver.findElementByXPath("//android.widget.TextView[@text='VAT']/following-sibling::android.widget.TextView[@index=1 and @resource-id='com.backbase.retail.neoUATMob:id/value']");
...
//            Double feecalculation=Double.parseDouble(ipremittance_fee.substring(4,len))+Double.parseDouble(ipcorr_fee.substring(4,len));


           // assertions.Assertions(fees.getText(),Double.toString(feecalculation));
            ...
            ex.getdats(FromAccountNumber,BeneficiaryAccount,currency,Amount01,Charges,debamount.getText(),ipexcrate,ipcorr_fee,ipremittance_fee,vat.getText(),ReferenceNumber,status,"-");
        }
        else {
            ...
            assertions.Assertions(ipexcrate.substring(12,ipexcrate.length()),exrate.getText());
            ...
            assertions.Assertions(ipequivalentamount,calculatedamount.getText().substring(4,calculatedamount.getText().length()));
...
//ex.getdats(status,FromAccount,ToAcoount,ReferenceNumber);
    ...
    public  static void done_button1(AndroidDriver driver,String DEvicename){

        TouchAction touchAction=new TouchAction(driver);
        if(DEvicename.contains("S7")){
            touchAction.tap(new PointOption().withCoordinates(1243, 1967)).perform();
        }
else if(DEvicename.contains("J5")){
            touchAction.tap(new PointOption().withCoordinates( 624, 982)).perform();

        }
else {
            touchAction.tap(new PointOption().withCoordinates( 946, 1931)).perform();
...
//Thread.sleep(5000);
    ...
    public static void bene_icon(AndroidDriver driver,String Devicename){
        TouchAction touchAction=new TouchAction(driver);
        if(Devicename.toUpperCase().contains("S7")){
            touchAction.tap(new PointOption().withCoordinates(1317, 534)).perform();// **************s7
        }
      else if(Devicename.toUpperCase().contains("J5")){
            touchAction.tap(new PointOption().withCoordinates(659, 270)).perform();
        }
      else {
            touchAction.tap(new PointOption().withCoordinates(988, 412)).perform();
            //new TouchAction(driver)).tap(988, 412).perform()
        }
        // //****j5
...
public void FinalScreen(AndroidDriver driver,String FROMACC,String currency,String charges) throws InterruptedException, IOException {
    ...
    if (status.contains("Submitted")) {
        ...
        if (charges.equals("IPAC")) {
            ...
            assertions.Assertions(ipvatamount, vat.getText());
            ScreenShot.screenShot(driver,"D:\\j5\\InternationalTransfer'"+ ScreenShot.c+++"'.png");
            ex.getdats(FromAccountNumber, BeneficiaryAccount, currency, iptransferamount1, Charges, totalAmount.getText(), exchangeRate.getText(), "-", remitancefees.getText(), vat.getText(), referenceNumber.getText(), status,"-");
        }
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("com.backbase.retail.neoUATMob:id/textReason")));
        MobileElement reason = (MobileElement) driver.findElementById("com.backbase.retail.neoUATMob:id/textReason");
        String REASON=reason.getText();
        logger.info(REASON);
        MobileElement Bene_name = (MobileElement) driver.findElementByXPath("//android.widget.TextView[@text='Beneficiary Name']/following-sibling::android.widget.TextView[@resource-id='com.backbase.retail.neoUATMob:id/labelValue']");
        MobileElement transferamount = (MobileElement) driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ScrollView/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.ScrollView/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[1]/android.widget.TextView[2]");
        ...
        back_button(driver);
        back_button(driver);
        ex.getdats(FromAccountNumber, BeneficiaryAccount, currency, iptransferamount1, Charges, ipdebitamount, ipexcrate, ipcorr_fee, ipremittance_fee, ipvatamount, "-", status,REASON);
    }
}
}
...
public void same_currency_final_screen(AndroidDriver driver,String currency,String charges) throws IOException, InterruptedException {
    ...
    if(status.contains("Submitted")) {
        ...
        Bene_Acc.getText();
        logger.info("Validation for beneficiary ACCOUNT");
        assertions.Assertions(BeneficiaryAccount, Bene_Acc.getText().replaceAll("\\s+",""));
        MobileElement referenceNumber = (MobileElement) driver.findElementByXPath("//android.widget.TextView[@text='Reference number']/following-sibling::android.widget.TextView[@index=1 and @resource-id='com.backbase.retail.neoUATMob:id/labelValue']");
        logger.info("Reference Number " + referenceNumber.getText());
        MobileElement show_hide_button = (MobileElement) driver.findElementById("com.backbase.retail.neoUATMob:id/showHideBreakdown");
        show_hide_button.click();
        ...
        if (charges.contains("IPAC")) {
            ...
            assertions.Assertions(ipvatamount, vat.getText());
            ;
            ex.getdats(FromAccountNumber, BeneficiaryAccount, currency, iptransferamount1, Charges, totdebitamt.getText(), "-", corres.getText(), remi.getText(), vat.getText(), referenceNumber.getText(), status, " - ");
            ...
            logger.info("Validation for vat");
            assertions.Assertions(ipvatamount, vat.getText());
            ex.getdats(FromAccountNumber, BeneficiaryAccount, currency, iptransferamount1, Charges, totdebitamt.getText(), "-", "-", remi.getText(), vat.getText(), referenceNumber.getText(), status, " - ");
        }
            MobileElement el2 = (MobileElement) driver.findElementById("com.backbase.retail.neoUATMob:id/abc_btn_title");
            el2.click();

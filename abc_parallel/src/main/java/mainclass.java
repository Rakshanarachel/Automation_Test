...
//BetweenOwnAccouns betweenOwnAccouns=new BetweenOwnAccouns();
    ...
    public void launchDevice() throws MalformedURLException {
        ...
        dc.setCapability(MobileCapabilityType.DEVICE_NAME, "LG");
        dc.setCapability(MobileCapabilityType.UDID, "LMQ610PVUKAY9DNJMN");//42105b60ac1d946d,ce0117110d33510204
        ...
        driver = new AndroidDriver<AndroidElement>(new URL("http://127.0.0.1:4728/wd/hub"), dc);
    }
...
*/
    ...
    public Object[][] ExecutionData() {
        Object[][] arrayObject = read.getExcelData("D:\\testdatasss\\abc_parallel\\src\\main\\DataSheets\\FULLDATAS.xls","Sheet1");
        return arrayObject;
    }
